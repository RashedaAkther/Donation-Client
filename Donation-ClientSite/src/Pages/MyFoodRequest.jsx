  ...
  console.log(requestFood);
    ...
    const handleDelete = (_id) => {
        ...
        Swal.fire({
          ...
          fetch(`https://foods-donations-assignment.vercel.app/AddFoodRequest/${_id}`,{
          method:"DELETE"
          })
          .then(res=> res.json())
          .then(data=>{
            ...
            const remaining = requestFoodcards.filter(card => card._id !== _id);
    ...
    return (
        <div>
          <Helmet><title>My_Food_Request</title></Helmet>
              <Table hoverable>
      <Table.Head>
